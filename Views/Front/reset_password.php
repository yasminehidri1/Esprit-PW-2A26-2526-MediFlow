...
<head>
    ...
    <title>Réinitialiser le mot de passe — MediFlow</title>
...
<div class="auth-page">
    ...
    <div class="auth-left">
        <div class="auth-left-content">
            ...
            <p>Créez un nouveau mot de passe sécurisé pour votre compte MediFlow.</p>

            <div class="auth-feature">
                <span class="material-symbols-outlined">lock</span>
                <span class="auth-feature-text">Mot de passe fort et sécurisé</span>
            </div>
            <div class="auth-feature">
                <span class="material-symbols-outlined">verified_user</span>
                <span class="auth-feature-text">Minimum 8 caractères</span>
            </div>
            <div class="auth-feature">
                <span class="material-symbols-outlined">check_circle</span>
                <span class="auth-feature-text">Accès sécurisé à votre compte</span>
            </div>
        </div>
    </div>
                ...
                <div class="field-group">
                    ...
                    <div class="field-wrap">
                        ...
                        <input class="field-input" type="password" id="password" name="password"
                               placeholder="••••••••" autocomplete="new-password" required style="padding-right:44px;"/>
                        <button type="button" class="field-toggle-btn" onclick="togglePwd('password','eye-pass')">

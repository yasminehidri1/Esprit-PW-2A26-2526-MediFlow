...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-on-surface-variant mt-1">Review and remove community comments.</p>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-surface-container-lowest p-6 rounded-xl border-l-4 border-tertiary shadow-sm hover:shadow-md transition-shadow">
            ...
            <div class="flex justify-end">
                <a href="/integration/magazine/admin?controller=comment&showDeleteModal&id=<?= $comment['id'] ?>&redirect=/integration/magazine/admin/comments" 
                ...
                <button onclick="showDeleteModal('/integration/magazine/admin/comment/delete?id=<?= $comment['id'] ?>&redirect=/integration/magazine/admin/comments', 'comment')" 
    ...
    <div class="bg-surface-container-lowest rounded-2xl p-16 text-center">
        ...
        <a href="/integration/magazine/admin" class="inline-block mt-6 px-6 py-2.5 bg-primary text-on-primary rounded-lg font-semibold hover:opacity-90 transition-opacity">
            Back to Dashboard
        </a>
    </div>
    <?php endif; ?>

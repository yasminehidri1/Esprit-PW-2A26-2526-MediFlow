...
<head>
    ...
    <title>Modifier Utilisateur - MediFlow Admin</title>
    ...
    <header class="bg-white dark:bg-slate-800 border-b border-outline shadow-sm">
        <div class="flex items-center justify-between px-8 py-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-3xl font-bold bg-gradient-to-r from-primary to-primary-container bg-clip-text text-transparent">Modifier Utilisateur</h2>
                    <p class="text-on-surface-variant text-sm mt-1"><?php echo htmlspecialchars($user['prenom'] . ' ' . $user['nom']); ?></p>
                </div>
            </div>
        </div>
    </header>

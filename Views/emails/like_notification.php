...
<body>
    <div class="container">
        <div class="header">
            <h1>❤️ New Like on Your Article</h1>
        </div>
        <div class="content">
            <p>Hi there!</p>
            <div class="message">
                <strong><?= htmlspecialchars($userName) ?></strong> just liked your article:
                <br><br>
                <strong>"<?= htmlspecialchars($postTitle) ?>"</strong>
            </div>
            <p>Thank you for contributing to MediFlow Magazine! Keep creating great health content.</p>
            <div style="text-align: center;">
                <a href="<?= htmlspecialchars($_ENV['APP_URL'] ?? 'https://mediflow.local') ?>" class="button">View Article</a>
            </div>
        </div>
        <div class="footer">

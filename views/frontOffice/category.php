...
<div class="flex flex-wrap gap-2 mb-10">
  ...
  ?>
  <a href="frontOffice.php?action=category&cat=<?= urlencode($c) ?>"
...
<div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
  ...
  <div class="lg:col-span-8">
    ...
    <div class="text-center py-20">
      ...
      <a href="frontOffice.php" class="inline-block px-6 py-2.5 bg-primary text-on-primary rounded-lg font-headline font-bold hover:opacity-90 transition-opacity">
        Back to Home
      </a>
    </div>
    <?php endif; ?>
  ...
  <aside class="lg:col-span-4 space-y-10">
    ...
    <div class="p-2">
      ...
      <div class="flex flex-wrap gap-2">
        ...
        ?>
        <a href="frontOffice.php?action=category&cat=<?= urlencode($oc) ?>"

...
<aside class="h-screen w-64 fixed left-0 top-0 bg-slate-50 dark:bg-slate-900 flex flex-col py-6 z-50">
    ...
    <nav class="flex-1 space-y-1">
        <a class="flex items-center gap-3 px-4 py-3 bg-white dark:bg-slate-800 text-blue-700 dark:text-blue-400 rounded-l-none border-l-4 border-teal-600 font-['Manrope'] font-bold text-sm tracking-tight transition-colors" href="?action=products&method=list">
...
<main class="pl-64 pt-28 min-h-screen bg-surface">
    <div class="max-w-4xl mx-auto px-8 pb-12">
        ...
        <div class="bg-white rounded-2xl p-8 shadow-lg">
            ...
            <form method="POST" enctype="multipart/form-data" action="<?php echo isset($produit) ? '?action=products&method=update' : '?action=products&method=store'; ?>" class="space-y-8">
                    ...
                    <div class="mt-6">
                        ...
                        <div id="dropZone" class="cursor-pointer hover:border-primary transition border-2 border-dashed rounded-lg h-32 flex items-center justify-center bg-gray-50 hover:bg-blue-50" ondrop="handleDrop(event)" ondragover="handleDragOver(event)" ondragleave="handleDragLeave(event)">
                            <?php if (isset($produit) && !empty($produit['image'])): ?>
                                <img id="imagePreview" src="<?php echo htmlspecialchars($produit['image']); ?>" alt="Preview" class="max-h-full max-w-full object-contain">
                            <?php else: ?>
                ...
                <div class="flex gap-4 pt-4">
                    ...
                    <a 
                        href="?action=products&method=list" 

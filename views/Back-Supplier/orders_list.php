...
<head>
    ...
    <title>Commandes - Mediflow | Fournisseur</title>
...
<body class="bg-surface text-on-surface">
    ...
    <aside class="h-screen w-64 fixed left-0 top-0 bg-white dark:bg-slate-800 flex flex-col py-6 z-50 border-r border-surface-container">
        <div class="px-6 mb-10">
            ...
            <p class="text-xs text-secondary font-semibold uppercase mt-1 tracking-widest">Fournisseur</p>
        </div>
        <nav class="flex-1 space-y-1">
            <!-- Tab: Produits -->
            <a class="flex items-center gap-3 px-4 py-3 text-slate-500 dark:text-slate-400 font-['Manrope'] font-bold text-sm tracking-tight hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors" href="?action=supplier&controller=products&method=list">
                <span class="material-symbols-outlined">inventory_2</span>
                <span>Produits</span>
            </a>
            <!-- Active Tab: Commandes -->
            <a class="flex items-center gap-3 px-4 py-3 bg-white dark:bg-slate-800 text-primary dark:text-blue-400 rounded-l-none border-l-4 border-primary font-['Manrope'] font-bold text-sm tracking-tight transition-colors" href="?action=supplier&controller=orders&method=list">
    ...
    <main class="pl-64 pt-28 min-h-screen bg-surface">
        <div class="max-w-7xl mx-auto px-8 pb-12">
            ...
            <div class="text-center py-24">
                ...
                <p class="text-secondary font-body mb-6">Vous n'avez pas encore reçu de commande</p>
                <a href="?action=supplier&controller=products&method=list" class="inline-block px-6 py-3 bg-primary text-white rounded-xl hover:bg-primary/90 font-bold transition-colors">
                    📦 Gerer les produits
                </a>
            </div>
            <?php else: ?>
                        ...
                        <tr class="hover:bg-surface-container-lowest transition">
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="?action=supplier&controller=orders&method=view&id=<?php echo $commande['id']; ?>" class="inline-flex items-center justify-center w-9 h-9 bg-primary/10 text-primary hover:bg-primary hover:text-white rounded-lg transition-colors" title="Voir détails">

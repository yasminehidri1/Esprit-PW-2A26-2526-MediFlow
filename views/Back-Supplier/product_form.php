...
<aside class="h-screen w-64 fixed left-0 top-0 bg-slate-50 dark:bg-slate-900 flex flex-col py-6 z-50">
    <div class="px-6 mb-10">
        ...
        <p class="text-xs text-slate-500 font-medium tracking-wider uppercase mt-1">Gestion Produits - Fournisseur</p>
    </div>
...
<main class="pl-64 pt-28 min-h-screen bg-surface">
    <div class="max-w-4xl mx-auto px-8 pb-12">
        ...
        <div class="bg-white rounded-2xl p-8 shadow-lg">
            ...
            <form method="POST" enctype="multipart/form-data" action="<?php echo isset($produit) ? '?action=supplier&controller=products&method=update' : '?action=supplier&controller=products&method=store'; ?>" class="space-y-8">
                ...
                <div class="flex gap-4 pt-4">
                    ...
                    <a 
                        href="?action=supplier&controller=products&method=list" 

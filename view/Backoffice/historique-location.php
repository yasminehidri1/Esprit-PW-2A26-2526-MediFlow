...
<aside class="sidebar-admin">
  ...
  <nav class="sb-admin-nav">
    ...
    <a href="/projet%20web/view/Backoffice/historique-location.php" class="active">
      <span class="material-symbols-outlined">history</span>Historique Location
    </a>
    <a href="/projet%20web/view/Backoffice/equipements.php">
...
<div class="main-admin">
  ...
  <header class="topbar-admin">
    <div class="topbar-admin-title">Historique de<br>Location</div>
    <div style="flex:1;max-width:300px;"><!-- espace --></div>
    <div class="topbar-admin-links"><a href="#">Dashboard</a><a href="#">Support</a></div>

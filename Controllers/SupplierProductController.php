 ...
 * Gère la logique métier pour les produits - BackOffice Fournisseur
 * 
...
class SupplierProductController {
    ...
    /**
     * Affiche la liste des produits (BackOffice Fournisseur)
     */
    public function list() {
        try {
            ...
            include 'views/Back-Supplier/products_list.php';
        } catch (Exception $e) {
            $this->errors[] = $e->getMessage();
            include 'views/Back-Supplier/error.php';
        }
    }
    ...
    public function search() {
        try {
            ...
            if (empty($keyword)) {
                header('Location: ?action=supplier&controller=products&method=list');
                exit;
            }
    ...
    public function create() {
        try {
            ...
            include 'views/Back-Supplier/product_form.php';
        } catch (Exception $e) {
            $this->errors[] = $e->getMessage();
            include 'views/Back-Supplier/error.php';
        }
    ...
    public function store() {
        try {
            ...
            header('Location: ?action=supplier&controller=products&method=create');
            exit;
        }
    }
    ...
    public function update() {
        try {
            ...
            $this->errors[] = $e->getMessage();
            $_SESSION['errors'] = $this->errors;
            header('Location: ?action=supplier&controller=products&method=edit&id=' . $id);
            exit;
        }
    }
